...
# You can check whether "quit" is a palindrome, you don't have to go out of your way to make sure you do not (You may check if quit is a palindrome OR you can ignore it and just exit, doing either is okay.)
